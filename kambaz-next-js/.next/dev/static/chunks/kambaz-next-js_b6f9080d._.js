...
function Dashboard() {
    ...
    const onEnroll = async (courseId)=>{
        if (currentUser) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$Kambaz$292f$Courses$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enrollIntoCourse"](currentUser?._id, courseId);
            await fetchEnrollments();
        }
    };
    const onUnenroll = async (courseId)=>{
        if (currentUser) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$Kambaz$292f$Courses$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unenrollFromCourse"](currentUser?._id, courseId);
            await fetchEnrollments();
